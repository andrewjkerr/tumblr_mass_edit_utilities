...
class Net::HTTP < Net::Protocol
  ...
  def self.Proxy(p_addr = nil, p_port = nil, p_user = nil, p_pass = nil, p_use_ssl = nil); end
  ...
  def self.new(address, port = nil, p_addr = nil, p_port = nil, p_user = nil, p_pass = nil, p_no_proxy = nil, p_use_ssl = nil); end
  def self.newobj(*, **); end
  ...
  def self.put(url, data, header = nil); end
